...
- ⚠️ Real-time threat detection with alerts and risk scores  
...
- Collect security-related data from:
  - Network traffic  
  - System logs  
  - APIs  
  - Files  
...
- **Data Sources**  
  Users, Wi-Fi traffic, VPN traffic, system logs, global threat feeds  
...
- Tailwind CSS  
- shadcn/ui  
- Three.js (3D threat & globe visualization)  
